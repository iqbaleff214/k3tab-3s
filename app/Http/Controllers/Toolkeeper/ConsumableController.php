...
class ConsumableController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of(Consumable::all())
                ...
                ->addColumn('action', function($row) {
                    return '<a href="' . route('toolkeeper.consumable.show', $row) . '" class="btn btn-sm btn-success">Show</a>
                            <a href="' . route('toolkeeper.consumable.edit', $row) . '" class="btn btn-sm btn-primary">Edit</a>';
                })
                ->rawColumns(['action'])
                ->make(true);
        }
        return view('pages.toolkeeper.consumable.index', [
            'title' => 'Consumables',
        ]);
    }
    ...
    {
        return view('pages.toolkeeper.consumable.show', [
    ...
    {
        return view('pages.toolkeeper.consumable.edit', [

                                ...
                                <div class="row">
                                    <div class="col-12 col-md-8">
                                        <ul>
                                            ...
                                            <li>The password used to login is the same as salary number.</li>
                                        </ul>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <a href="{{ asset('templates/serviceman-template.xlsx') }}" class="btn btn-outline-dark btn-block" download>Download Template</a>
                                    </div>
                                </div>
                                <div class="row mt-5">

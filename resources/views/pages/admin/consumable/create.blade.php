    ...
    <div class="content-wrapper p-2">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-12 col-md-12 px-2">
                    <div class="card card-navy collapsed-card">
                        ...
                        <div class="card-body" style="display: none;">
                            <form action="{{ route('admin.consumable.import') }}" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <a href="{{ asset('templates/consumables-template.xlsx') }}" class="btn btn-outline-dark btn-block" download>Download Template</a>
                                    </div>
                                </div>
                                <div class="row mt-5">
                ...
                <div class="col-12 col-md-12 px-2">
                    <!-- Default box -->
                    <form action="{{ route('admin.consumable.store') }}" method="POST">
                        @csrf
